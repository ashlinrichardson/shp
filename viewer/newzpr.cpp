...
void zprInit(){
    ...
    void zprReshape(int w,int h){  //callback triggered by fetching active GLUT window ID
...
void processHits(GLint hits, GLuint buffer[]) //http://www.lighthouse3d.com/opengl/picking/index.php?openglway3 
{
    myPickNames.clear();
    unsigned int i, j;
